...
@observer
class SearchDealerOnButtonQuote extends Component<Props, {}> {
          ...
          trigger={
              <a  
                ...
                onClick=
                  { () =>  
                    {
                      this.props.mainStore.trackingEventDealer('Quote Your Tires - Top');
...
export default typedInject('mainStore')(SearchDealerOnButtonQuote);