...
@observer
class SearchDealerOnStickyButton extends Component<Props, {}> {
    ...
    return (STRCONSTANT.common.default.schedule_service);
        ...
        <Modal
          ...
          trigger={
              <a
                ...
                onClick=
                { 
                  () => { this.props.mainStore.trackingEventDealer('Schedule an Appointment - Sticky Button');
                          this.props.mainStore.openSearchDealerModal('ScheduleAppointment');
                        }
                } 
                target="_blank" title="">
                  <span  id="change-your-dealer" style={{ color: '#fff' }}>{ this.displayScheduleAppointment() }</span>
              </a>
          }
        >
        <Modal.Header>
...
export default typedInject('mainStore')(SearchDealerOnStickyButton);