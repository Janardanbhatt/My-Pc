...
@observer
class SearchDealerOnButton extends Component<Props, {}> {
        ...
        <Modal
          ...
          trigger={
              <a className="btn_black"
                ...
                onClick=
                { 
                  () => { this.props.mainStore.trackingEventDealer('Schedule an Appointment - Top');
                          this.props.mainStore.openSearchDealerModal('ScheduleAppointment');
                        }
                } 
                target="_blank" title="">
                  <span  id="change-your-dealer">{ this.displayScheduleAppointment() }</span>
              </a>
          }
        >
        <Modal.Header>
...
export default typedInject('mainStore')(SearchDealerOnButton);