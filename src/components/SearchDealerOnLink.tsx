...
@observer
class SearchDealerOnLink extends Component<Props, {}> {
        ...
        <Modal
          ...
          trigger={
              <a 
                ...
                onClick={
                 () =>   {
                  this.props.mainStore.trackingEventDealer('Visit the Fitting Room - 1');
...
export default typedInject('mainStore')(SearchDealerOnLink);