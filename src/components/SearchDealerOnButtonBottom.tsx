...
@observer
class SearchDealerOnButtonBottom extends Component<Props, {}> {
          ...
          trigger={
              <a  className="btn_black"
                ...
                onClick={ 
                  () => 
                  { 
                    this.props.mainStore.trackingEventDealer('Schedule an Appointment - Bottom');
                    this.props.mainStore.openSearchDealerModal('ScheduleAppointment')
                  }
                }
                target="_blank" title="">
                <span  id="change-your-dealer">
                  { this.displayScheduleAppointment() }
                </span>
              </a>
          }
        >
...
export default typedInject('mainStore')(SearchDealerOnButtonBottom);