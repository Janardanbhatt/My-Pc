...
@observer
class SearchDealerOnLinkTwo extends Component<Props, {}> {
        ...
        <Modal
          ...
          trigger={
              <a 
                ...
                onClick={
                 () =>   {
                  this.props.mainStore.trackingEventDealer('Visit the Fitting Room - 2');
                  this.props.mainStore.openSearchDealerModal('');
                  }
                 }
              >
              <FontAwesomeIcon icon={faAngleRight} size={'sm'} />
              &nbsp;
              <FormattedMessage id="visit-fitting-room" defaultMessage={ STRCONSTANT.common.default.visit_fitting_room } />
              </a>
          }
        >
        <Modal.Header>
...
export default typedInject('mainStore')(SearchDealerOnLinkTwo);